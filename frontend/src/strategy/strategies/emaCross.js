...
export function runStrategy(candles) {
    ...
    // Sustained trend — only if spread is wide enough AND ADX confirms
    else if (absSpread > 0.3 && strongTrend) {
    ...
    // Otherwise — EMAs are tangled or no trend strength → Neutral
    else {
