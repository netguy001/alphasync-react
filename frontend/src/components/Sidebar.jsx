...
export default function Sidebar({ collapsed, onToggle }) {
    ...
    return (
      ...
      transition-all duration-300 w-[240px]
      ${collapsed ? 'lg:w-[72px] max-lg:-translate-x-full' : 'lg:w-[240px] max-lg:translate-x-0'}`}>>

                {/* Logo */}
                <div className="flex items-center gap-3 px-5 h-16 border-b border-edge/5">
                ...
                <div className="p-3 border-t border-edge/5">
                    {!collapsed && user && (
                        <div className="px-3 py-2 mb-2">
                            <p className="text-sm font-medium text-heading truncate">{user.full_name || user.username}</p>
