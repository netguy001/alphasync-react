 ...
 * @param {{ side: string, order_type: string, quantity: number|string, price: number|string, triggerPrice: number|string }} form
 * @returns {{ valid: boolean, error: string|null }}
 */
export const validateOrderForm = ({ side, order_type, quantity, price, triggerPrice }) => {
